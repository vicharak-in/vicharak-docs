...
---------------
Prerequisites
- Linux kernel with RK3576 audio drivers enabled 
- Root access
...
In Axon Lite, you will be shown below audio devices :
...
- Review the output from the commands above to locate the card corresponding to the RK3576 audio codec.
...
- Linux Kernel: RK3576 audio drivers and device-tree bindings
