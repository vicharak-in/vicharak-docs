...
that connects to the CSI connector on the Axon Lite and allows you to take
photos and videos.

We do not build or design the camera module, but we do test it for
compatibility with our Axon Lite. We recommend buying the original camera
...
..
    Enable Overlays In Axon Lite / Axon Lite
    ------------------------
