...
Active heat sink can be run on `5V` through GPIO Header pins available on Axon Lite.

.. tip::
  
  `Axon Lite GPIO Header Pin <https://docs.vicharak.in/vicharak_sbcs/axon-lite/axon-lite-gpio-description/#axon-lite-gpios-header>`_
