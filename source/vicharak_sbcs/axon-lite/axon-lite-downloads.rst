...
`Download File </_static/files/AXON LITE_3D_file_V0.3.step.7z>`_

**Axon Lite 3D Printed Case Files**

- Axon Lite Enclosure Installation Guide

.. note::

   The Axon Lite enclosure combines a snap-fit design with screws for added stability, allowing secure and easy access to the board's components.
...
`Download File </_static/files/Axon Lite0p3_0p2_Case_121224.zip>`_
...
.. seealso::
    ...
    :ref:`Frequently Asked Questions <axon-lite-faq>`
