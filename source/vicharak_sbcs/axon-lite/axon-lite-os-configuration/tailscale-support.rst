...
.. note::
    ...
    <https://downloads.vicharak.in/vicharak-axon-lite/debian/13_trixie/>`_ , in order to support. Flash Image
    ...
    You can also use Kernel linux-image-5.10.160-axon-lite.
