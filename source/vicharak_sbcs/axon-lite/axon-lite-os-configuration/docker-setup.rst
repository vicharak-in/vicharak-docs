...
Setting Up Docker on Axon Lite
=========================

Docker is a containerization platform that allows you to run applications in isolated environments. Follow the steps below to install and configure Docker on your Axon Lite device.
