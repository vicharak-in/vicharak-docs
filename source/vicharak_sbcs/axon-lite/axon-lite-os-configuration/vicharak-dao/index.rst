...
.. note::
   ...
   - **Serial Console** — See `Documentation <https://docs.vicharak.in/vicharak_sbcs/axon-lite/axon-lite-getting-started/#using-serial-console>`_ (Baudrate: 1500000)  
   - **SSH** — See `Documentation <https://docs.vicharak.in/vicharak_sbcs/axon-lite/axon-lite-getting-started/#using-ssh>`_ (``vicharak@<IP>``) — both devices must be on the **same network**.  
