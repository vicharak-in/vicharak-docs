...
Welcome to the Axon Lite Linux Development Guide, designed especially for those
new to the world of Single Board Computers! This guide will walk you through
the fundamental steps of creating the Axon Lite Linux Operating System,
...
..
   Linux SDK <axon-lite-linux-sdk>
   Linux Kernel <axon-lite-linux-kernel>
