...
<!-- TODO: Add AXON LITE vicharak-config guide & link -->
...
> **Note:** Windows users refer to [Getting Started with Axon Lite **UART Serial Console**](../../axon-lite-getting-started.rst#using-serial-console).

#### Preparation

- To access Axon Lite SBC through the serial interface, a USB to UART serial cable or adapter is required.
...
2. Connect the serial cable or adapter to the Axon Lite SBC.
...
Getting Started with Axon Lite [**Using SSH**](../../axon-lite-getting-started.rst#using-ssh)
:::
...
**Access Axon Lite SBC through SSH**
...
:::{tip}
Replace **"username"** with the appropriate username for Axon Lite and **"ip_address"** with the
actual IP address assigned to Axon Lite on the network.
:::
...
:::{tip}
Replace **"username"** with the appropriate username for Axon Lite and **"pc-name"** with the
actual PC name assigned to Axon Lite on the network.
:::
