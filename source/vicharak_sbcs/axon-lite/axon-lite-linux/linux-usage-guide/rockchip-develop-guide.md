...
development tool for Windows, and [**Linux Upgrade Tool**](#linux-axon-lite-upgrade-tool)
for Linux and mac-OS.

This tool is used to upgrade or flash the firmware on Rockchip SoCs and it is the primary tool
used for flashing **Axon Lite Linux** images to the eMMC, SD-Card, or other storage devices.
...
We will use [**Linux Upgrade Tool**](#linux-axon-lite-upgrade-tool) for Linux/Mac-OS and
