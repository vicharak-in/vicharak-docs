...
The Vicharak-Axon Lite board includes a dedicated M.2 expansion slot that supports NVMe solid-state drives using the PCI Express (PCIe) Gen 3 interface with four lanes (x4)

.. image:: /_static/images/rk3576-axon-lite/axon-lite-PCIE3.0.webp
   :width: 70%
...
-------------------------------
.. image:: /_static/images/rk3576-axon-lite/axon-lite-pcie-2230-2242-2260-2280.webp
   :width: 10%
