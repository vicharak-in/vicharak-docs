...
The HDMI RX (Receiver) port on Axon Lite allows you to capture video input from HDMI sources. This documentation covers how to set up and receive video data using two Axon Lite boards and the V4L2 (Video4Linux2) tool.

.. note::

   Instead of using another Axon Lite board as a video source, you can use any other source. This page shows how to connect two Axon Lite boards.
...
- 2x Axon Lite boards (one as TX/transmitter and one as RX/receiver)
- 2x HDMI cables 
...
1. Connect the HDMI TX output from the first Axon Lite board (TX board) to **Mini-HDMI to HDMI converter** then connect HDMI RX input of the second Axon Lite board (RX board) to it.
...
1. SSH into the RX Axon Lite board:
...
.. image:: /_static/images/rk3576-axon-lite/axon-lite-q4l2.webp
   :width: 70%
...
- Verify the HDMI source resolution is supported by Axon Lite
