...
.. TODO: Add axon-lite-linux-uart-serial-console (Axon Lite Linux Usage Guide)
...
.. tab-set::
    ...
    .. tab-item:: Windows
        ...
        - Connect the device to the PC and use the :ref:`Serial Console Tool <axon-lite-serial-console>` to open the serial port of the device.
    ...
    .. tab-item:: Linux
        ...
        - Connect the device to the PC and use the :ref:`axon-lite-linux-uart-serial-console` to open the serial port of the device.
