...
.. note::
    | For Axon Lite, you can download the bootable image from the :ref:`Downloads <axon-lite-downloads>` page.
...
Connect the PD cable to the Axon Lite SBC and the PD adapter to the power socket.
