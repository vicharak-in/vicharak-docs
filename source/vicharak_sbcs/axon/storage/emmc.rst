...
- Linux kernel MMC/SDHCI driver drives the eMMC interface and exposes the device as /dev/mmcX (and /dev/mmcblkXn), use the command "lsblk"
...
- If the eMMC is not detected, check kernel logs for MMC/SOH/SDHCI messages to identify initialization or timing issues
