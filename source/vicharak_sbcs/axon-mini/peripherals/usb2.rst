...
Axon Mini has two USB **2.0 port** ( **480 Mbps** ). This guide explains how to use and inspect USB 2.0 interfaces on a Linux system.

.. image:: /_static/images/rk3588-axon/axon-mini-usb2.webp
   :width: 74%
...
.. code-block:: bash
    ...
    vicharak@axon-mini:~$ lsusb -t
      /:  Bus 001.Port 001: Dev 001, Class=root_hub, Driver=xhci-hcd/1p, 480M
         |__ Port 001: Dev 002, If 0, Class=Hub, Driver=hub/4p, 480M
            |__ Port 002: Dev 004, If 0, Class=Vendor Specific Class, Driver=r8152, 480M
