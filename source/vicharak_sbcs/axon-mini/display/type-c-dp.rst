...
.. image:: /_static/images/qcs6490-axon/axon-dp.webp
   :width: 80%

Axon Mini provides a Type-C DisplayPort 1.4a interface for high-resolution display output with high video bandwidth. The DP connector on QCS6490 is used for direct connections to DP-compatible displays, projectors, and USB-C docking stations.
