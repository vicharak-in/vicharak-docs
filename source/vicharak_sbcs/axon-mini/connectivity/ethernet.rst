...
The Axon Mini SBC provides a single Gigabit Ethernet interface for wired network
...
- **Connector**: 1 × RJ45
- **Speed**: 10 / 100 / 1000 / 2500 Mbps (2.5GbE)
- **Ethernet Controller**: Realtek RTL8156BG-CG
- **Interface Type**: USB 3.0 / USB 3.1 Gen 1 to Ethernet

Connecting Ethernet
-------------------

Insert one end of an Ethernet cable into the RJ45 Ethernet port on the Axon SBC
and connect the other end to a network switch, router, or Ethernet wall outlet.

The Ethernet interface supports auto-negotiation and will automatically
establish a link at the highest speed supported by both the board and the
...
.. code-block:: bash
axon/connectivity/ethernet.rst
   ping -c 4 8.8.8.8
