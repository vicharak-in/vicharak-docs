...
You can also use the **Type-C DisplayPort** interface as an alternate display output.

.. admonition:: Check out Linux Documentation
   :class: tip

   Once the Axon Mini is connected to the monitor, you can follow the
   :doc:`Axon Mini Linux Documentation <axon-mini-linux/index>` to continue setup.
