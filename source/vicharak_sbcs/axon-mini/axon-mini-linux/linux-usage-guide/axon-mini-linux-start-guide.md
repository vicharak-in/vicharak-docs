...
(axon-mini-linux-start-guide)=

# Vicharak Linux Start Guide

Vicharak provides Linux distributions for Axon Mini SBC such as Debian. This guide will help you get started with Vicharak Linux systems.
...
<!-- TODO: Add AXON MINI vicharak-config guide & link -->
...
(axon-mini-linux-uart-serial-console)=

### UART Serial Console

> **Note:** Windows users refer to [Getting Started with Axon Mini **UART Serial Console**](../../axon-mini-getting-started.rst#using-serial-console).

#### Preparation

- To access Axon Mini SBC through the serial interface, a USB to UART serial cable or adapter is required.
...
2. Connect the serial cable or adapter to the Axon Mini SBC.
...
> **Note:** Ensure that the cable is properly connected to the appropriate serial port on both devices. Use baud rate **115200**.
...
For Axon Mini, set the baud rate to **115200**. Configure and Press **Enter** to save the settings.
...
Getting Started with Axon Mini [**Using SSH**](../../axon-mini-getting-started.rst#using-ssh)
:::
...
**Access Axon Mini SBC through SSH**
...
:::{tip}
Replace **"username"** with the appropriate username for Axon Mini and **"ip_address"** with the
actual IP address assigned to Axon Mini on the network.
:::
...
:::{tip}
Replace **"username"** with the appropriate username for Axon Mini and **"pc-name"** with the
actual PC name assigned to Axon Mini on the network.
:::

:::{seealso}
[QDL Flash Tool Guide](qdl-tool-guide.rst)

[Frequently Asked Questions](../../axon-mini-faq.rst)
:::
